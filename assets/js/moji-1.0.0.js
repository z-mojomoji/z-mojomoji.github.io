...
throw new Error("Module build failed: Error: Couldn't find preset \"env\" relative to directory \"/Users/suphicha/Moji/Work/Git/z-mojomoji.github.io/node_modules/rxjs/_esm5/internal/scheduled\"\n    at /Users/suphicha/Moji/Work/Git/z-mojomoji.github.io/node_modules/babel-core/lib/transformation/file/options/option-manager.js:293:19\n    at Array.map (<anonymous>)\n    at OptionManager.resolvePresets (/Users/suphicha/Moji/Work/Git/z-mojomoji.github.io/node_modules/babel-core/lib/transformation/file/options/option-manager.js:275:20)\n    at OptionManager.mergePresets (/Users/suphicha/Moji/Work/Git/z-mojomoji.github.io/node_modules/babel-core/lib/transformation/file/options/option-manager.js:264:10)\n    at OptionManager.mergeOptions (/Users/suphicha/Moji/Work/Git/z-mojomoji.github.io/node_modules/babel-core/lib/transformation/file/options/option-manager.js:249:14)\n    at OptionManager.init (/Users/suphicha/Moji/Work/Git/z-mojomoji.github.io/node_modules/babel-core/lib/transformation/file/options/option-manager.js:368:12)\n    at File.initOptions (/Users/suphicha/Moji/Work/Git/z-mojomoji.github.io/node_modules/babel-core/lib/transformation/file/index.js:212:65)\n    at new File (/Users/suphicha/Moji/Work/Git/z-mojomoji.github.io/node_modules/babel-core/lib/transformation/file/index.js:135:24)\n    at Pipeline.transform (/Users/suphicha/Moji/Work/Git/z-mojomoji.github.io/node_modules/babel-core/lib/transformation/pipeline.js:46:16)\n    at transpile (/Users/suphicha/Moji/Work/Git/z-mojomoji.github.io/node_modules/babel-loader/lib/index.js:50:20)\n    at Object.module.exports (/Users/suphicha/Moji/Work/Git/z-mojomoji.github.io/node_modules/babel-loader/lib/index.js:173:20)");
...
var Subject_Subject = /*@__PURE__*/function (_super) {
    ...
    Subject.prototype.next = function (value) {
        if (this.closed) {
            throw new /* Cannot get final name for export "ObjectUnsubscribedError" in "./node_modules/rxjs/_esm5/internal/util/pipe.js" (known exports: pipe pipeFromArray, known reexports: ) */ undefined();
        }
        if (!this.isStopped) {
    ...
    Subject.prototype._subscribe = function (subscriber) {
        if (this.closed) {
            ...
            return new /* Cannot get final name for export "SubjectSubscription" in "./node_modules/rxjs/_esm5/internal/Observable.js" (known exports: Observable, known reexports: ) */ undefined(this, subscriber);
        }
    };
    Subject.prototype.asObservable = function () {
        var observable = new /* Cannot get final name for export "Observable" in "./node_modules/rxjs/_esm5/internal/util/noop.js" (known exports: noop, known reexports: ) */ undefined();
        observable.source = this;
        return observable;
    };
    ...
    return Subject;
}(/* Cannot get final name for export "Observable" in "./node_modules/rxjs/_esm5/internal/util/noop.js" (known exports: noop, known reexports: ) */ undefined);
...
}(/* Cannot get final name for export "Subject" in "./node_modules/rxjs/_esm5/internal/util/ObjectUnsubscribedError.js" (known exports: ObjectUnsubscribedError, known reexports: ) */ undefined);
...
function fromArray(input, scheduler) {
    if (!scheduler) {
        ...
        return Object(scheduleArray["scheduleArray"])(input, scheduler);
    }
}
...
function of() {
    ...
    if (isScheduler(scheduler)) {
        args.pop();
        return Object(scheduleArray["scheduleArray"])(args, scheduler);
    } else {
...
var Notification_Notification = /*@__PURE__*/function () {
    ...
    Notification.prototype.toObservable = function () {
        ...
        switch (kind) {
            case 'N':
                return /* Cannot get final name for export "of" in "./node_modules/rxjs/_esm5/internal/observable/fromArray.js" (known exports: fromArray, known reexports: ) */ undefined(this.value);
            case 'E':
                return /* Cannot get final name for export "throwError" in "./node_modules/rxjs/_esm5/internal/observable/of.js" (known exports: of, known reexports: ) */ undefined(this.error);
            case 'C':
                return /* Cannot get final name for export "empty" in "./node_modules/rxjs/_esm5/internal/scheduler/queue.js" (known exports: queue, known reexports: ) */ undefined();
        }
...
var ReplaySubject_ReplaySubject = /*@__PURE__*/function (_super) {
    ...
    ReplaySubject.prototype._subscribe = function (subscriber) {
        ...
        if (this.closed) {
            ...
            this.observers.push(subscriber);
            subscription = new /* Cannot get final name for export "SubjectSubscription" in "./node_modules/rxjs/_esm5/internal/Observable.js" (known exports: Observable, known reexports: ) */ undefined(this, subscriber);
        }
        if (scheduler) {
            subscriber.add(subscriber = new /* Cannot get final name for export "ObserveOnSubscriber" in "./node_modules/rxjs/_esm5/internal/Notification.js" (known exports: NotificationKind Notification, known reexports: ) */ undefined(subscriber, scheduler));
        }
    ...
    ReplaySubject.prototype._getNow = function () {
        return (this.scheduler || /* Cannot get final name for export "queue" in "./node_modules/rxjs/_esm5/internal/scheduler/QueueScheduler.js" (known exports: QueueScheduler, known reexports: ) */ undefined).now();
    };
...
// EXTERNAL MODULE: ./node_modules/rxjs/_esm5/internal/scheduled/scheduled.js
var scheduled = __webpack_require__(85);
...
function from(input, scheduler) {
    if (!scheduler) {
        ...
        return Object(scheduled["scheduled"])(input, scheduler);
    }
}
...
function animate(el, keyframes, options) {
  return /* Cannot get final name for export "Observable" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined.create(function (observer) {
...
var featuresOk = /* Cannot get final name for export "hasFeatures" in "./node_modules/qd-set/esm/index.js" (known exports: Set, known reexports: ) */ undefined(REQUIREMENTS);
...
function renderKatex(el, tex) {
  try {
    ...
    if (prev && prev.classList && prev.classList.contains('MathJax_Preview')) {
      /* Cannot get final name for export "hide" in "./node_modules/qd-set/esm/index.js" (known exports: Set, known reexports: ) */ undefined.call(prev);
    }
  } catch (e) {
...
var createElement = /* Cannot get final name for export "createCreateElement" in "./node_modules/hy-component/src/component.js" (known exports: COMPONENT_FEATURE_TESTS componentMixin, known reexports: Set) */ undefined(document.createElement.bind(document), document.createTextNode.bind(document));
...
var COMPONENT_FEATURE_TESTS = new /* Cannot get final name for export "Set" in "./node_modules/create-element-x/factory.js" (known exports: createCreateElement default, known reexports: ) */ undefined(["customevent"]);
  ...
  return function (_C) {
    ...
    rxjs__createClass(_class, [{
      ...
      value: function setupComponent(el, opts) {
        ...
        this.subjects = {};
        this.subjects.disconnect = new /* Cannot get final name for export "Subject" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined();
        this.subjects.document = new /* Cannot get final name for export "ReplaySubject" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined();

        Object.keys(this.constructor.types).map(function (key) {
          _this2.subjects[key] = new /* Cannot get final name for export "ReplaySubject" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(1);
...
var array_of_arrayOf = function arrayOf(type) {
  var f = function f(attr) {
    if (attr == null) return null;
    var a = /* Cannot get final name for export "array" in "./node_modules/attr-types/bool.js" (known exports: bool default, known reexports: ) */ undefined(attr).map(type);
  ...
  f.stringify = function (a) {
    ...
    if (a2 && a2.reduce(function (r, x) {
      ...
      return /* Cannot get final name for export "array" in "./node_modules/attr-types/bool.js" (known exports: bool default, known reexports: ) */ undefined.stringify(a2);
    }
    return null;
  };
...
/* harmony default export */ var attr_types = ({
  array: /* Cannot get final name for export "array" in "./node_modules/attr-types/bool.js" (known exports: bool default, known reexports: ) */ undefined, arrayOf: /* Cannot get final name for export "arrayOf" in "./node_modules/attr-types/number.js" (known exports: number default, known reexports: ) */ undefined, bool: /* Cannot get final name for export "bool" in "./node_modules/attr-types/one-of.js" (known exports: oneOf default, known reexports: ) */ undefined, number: /* Cannot get final name for export "number" in "./node_modules/attr-types/regex.js" (known exports: regex default, known reexports: ) */ undefined, oneOf: /* Cannot get final name for export "oneOf" in "./node_modules/attr-types/string.js" (known exports: string default, known reexports: ) */ undefined, regex: regex, string: string
});
...
/* harmony default export */ var src_types = ({
  array: /* Cannot get final name for export "array" in "./node_modules/rxjs/_esm5/internal/operators/audit.js" (known exports: audit, known reexports: ) */ undefined,
  arrayOf: /* Cannot get final name for export "arrayOf" in "./node_modules/rxjs/_esm5/internal/operators/audit.js" (known exports: audit, known reexports: ) */ undefined,
  bool: /* Cannot get final name for export "bool" in "./node_modules/rxjs/_esm5/internal/operators/audit.js" (known exports: audit, known reexports: ) */ undefined,
  number: /* Cannot get final name for export "number" in "./node_modules/rxjs/_esm5/internal/operators/audit.js" (known exports: audit, known reexports: ) */ undefined,
  oneOf: /* Cannot get final name for export "oneOf" in "./node_modules/rxjs/_esm5/internal/operators/audit.js" (known exports: audit, known reexports: ) */ undefined,
  regex: /* Cannot get final name for export "regex" in "./node_modules/rxjs/_esm5/internal/operators/audit.js" (known exports: audit, known reexports: ) */ undefined,
  string: /* Cannot get final name for export "string" in "./node_modules/rxjs/_esm5/internal/operators/audit.js" (known exports: audit, known reexports: ) */ undefined
});
...
var operators_subscribeWhen = function subscribeWhen(p$) {
  return function (source) {
    ...
    return p$.pipe(/* Cannot get final name for export "switchMap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (p) {
      return p ? source : /* Cannot get final name for export "never" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined();
    }));
  };
};
...
var operators_filterWhen = function filterWhen(p$) {
  ...
  return function (source) {
    if (true && !p$) throw Error();else if (others.length === 0) {
      return source.pipe(/* Cannot get final name for export "withLatestFrom" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(p$), /* Cannot get final name for export "filter" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref) {
        var _ref2 = _slicedToArray(_ref, 2),
            p = _ref2[1];

        return p;
      }), /* Cannot get final name for export "map" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref3) {
      ...
      return source.pipe(/* Cannot get final name for export "withLatestFrom" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined.apply(undefined, [p$].concat(others)), /* Cannot get final name for export "filter" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref5) {
      ...
      }), /* Cannot get final name for export "map" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref7) {
    ...
    calc__createClass(_class, [{
      ...
      value: function calcWillOpen(_ref3) {
        ...
        switch (this.align) {
          case "left":
            {
              if (velocity > /* Cannot get final name for export "VELOCITY_THRESHOLD" in "./node_modules/hy-drawer/src/mixin/observables.js" (known exports: baseObservablesMixin, known reexports: ) */ undefined) return true;else if (velocity < -/* Cannot get final name for export "VELOCITY_THRESHOLD" in "./node_modules/hy-drawer/src/mixin/observables.js" (known exports: baseObservablesMixin, known reexports: ) */ undefined) return false;else if (translateX >= this.drawerWidth / 2) return true;else return false;
            }
          case "right":
            {
              if (-velocity > /* Cannot get final name for export "VELOCITY_THRESHOLD" in "./node_modules/hy-drawer/src/mixin/observables.js" (known exports: baseObservablesMixin, known reexports: ) */ undefined) return true;else if (-velocity < -/* Cannot get final name for export "VELOCITY_THRESHOLD" in "./node_modules/hy-drawer/src/mixin/observables.js" (known exports: baseObservablesMixin, known reexports: ) */ undefined) return false;else if (translateX <= -this.drawerWidth / 2) return true;else return false;
  ...
  return function (_C) {
    ...
    observables__createClass(_class, [{
      ...
      value: function getStartObservable() {
        ...
        return /* Cannot get final name for export "combineLatest" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(this.subjects.document, this.subjects.mouseEvents).pipe(/* Cannot get final name for export "switchMap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref) {
          ...
          var touchstart$ = /* Cannot get final name for export "fromEvent" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(doc, "touchstart", {
            passive: true
          }).pipe(/* Cannot get final name for export "filter" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref3) {
            var touches = _ref3.touches;
            return touches.length === 1;
          }), /* Cannot get final name for export "map" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref4) {
          ...
          var mousedown$ = /* Cannot get final name for export "fromEvent" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(doc, "mousedown").pipe(/* Cannot get final name for export "tap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (event) {
            return event.event = event, event;
          }));

          return /* Cannot get final name for export "merge" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(touchstart$, mousedown$);
        }));
      }
      ...
      value: function getMoveObservable(start$, end$) {
        ...
        return /* Cannot get final name for export "combineLatest" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(this.subjects.document, this.subjects.mouseEvents, this.subjects.preventDefault).pipe(/* Cannot get final name for export "switchMap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref5) {
          ...
          var touchmove$ = /* Cannot get final name for export "fromEvent" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(doc, "touchmove", { passive: !preventDefault }).pipe(/* Cannot get final name for export "map" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (e) {
          ...
          var mousemove$ = /* Cannot get final name for export "fromEvent" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(doc, "mousemove", {
            passive: !preventDefault
          }).pipe(/* Cannot get final name for export "subscribeWhen" in "./node_modules/hy-drawer/src/mixin/setup.js" (known exports: setupObservablesMixin, known reexports: ) */ undefined(/* Cannot get final name for export "merge" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(start$.pipe(/* Cannot get final name for export "mapTo" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(true)), end$.pipe(/* Cannot get final name for export "mapTo" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(false)))), /* Cannot get final name for export "tap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (event) {
            return event.event = event, event;
          }));

          return /* Cannot get final name for export "merge" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(touchmove$, mousemove$);
        }));
      }
      ...
      value: function getEndObservable() {
        // Since the `mouseEvents` option may change at any point, we `switchMap` to reflect the changes.
        return /* Cannot get final name for export "combineLatest" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(this.subjects.document, this.subjects.mouseEvents).pipe(/* Cannot get final name for export "switchMap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref7) {
          ...
          var touchend$ = /* Cannot get final name for export "fromEvent" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(doc, "touchend", { passive: true }).pipe(/* Cannot get final name for export "filter" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref9) {
            var touches = _ref9.touches;
            return touches.length === 0;
          }), /* Cannot get final name for export "map" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (event) {
          ...
          var mouseup$ = /* Cannot get final name for export "fromEvent" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(doc, "mouseup", { passive: true });
          return /* Cannot get final name for export "merge" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(touchend$, mouseup$);
        }));
      }
      ...
      value: function getIsSlidingObservable(move$, start$, end$) {
        return this.getIsSlidingObservable2(move$, start$).pipe(/* Cannot get final name for export "take" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(1), /* Cannot get final name for export "startWith" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(undefined), /* Cannot get final name for export "repeatWhen" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function () {
          return end$;
        }));
      }
    }, {
      ...
      value: function getIsSlidingObservable2(move$, start$) {
        ...
        if (this.threshold) {
          return move$.pipe(/* Cannot get final name for export "withLatestFrom" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(start$), /* Cannot get final name for export "skipWhile" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref10) {
          ...
          }), /* Cannot get final name for export "map" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref12) {
          ...
          return move$.pipe(/* Cannot get final name for export "withLatestFrom" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(start$), /* Cannot get final name for export "map" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref14) {
  ...
  return function (_baseObservablesMixin) {
    ...
    setup__createClass(_class, [{
      ...
      value: function setupObservables() {
        ...
        var resize$ = /* Cannot get final name for export "fromEvent" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(window, "resize", { passive: true }).pipe(/* Cannot get final name for export "takeUntil" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(this.subjects.disconnect), /* Cannot get final name for export "share" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(), /* Cannot get final name for export "startWith" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined({}));

        // Keep measurements up-to-date.
        // Note that we need to temporarily remove the opened class to get the correct measures.
        resize$.pipe(/* Cannot get final name for export "takeUntil" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(this.subjects.disconnect)).subscribe(function () {
        ...
        var active$ = this.subjects.persistent.pipe(/* Cannot get final name for export "map" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (x) {
          return !x;
        }));
        ...
        var start$ = this.getStartObservable().pipe(/* Cannot get final name for export "takeUntil" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(this.subjects.disconnect), /* Cannot get final name for export "filterWhen" in "./node_modules/hy-drawer/src/mixin/setup.js" (known exports: setupObservablesMixin, known reexports: ) */ undefined(active$), /* Cannot get final name for export "share" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined());
        ...
        var isScrimVisible$ = /* Cannot get final name for export "defer" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(function () {
          return _this2.translateX$.pipe(/* Cannot get final name for export "map" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (translateX) {
            return _this2.align === "left" ? translateX > 0 : translateX < _this2.drawerWidth;
          }));
        });

        // TODO: ...
        var isInRange$ = start$.pipe(/* Cannot get final name for export "withLatestFrom" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(isScrimVisible$), /* Cannot get final name for export "map" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref) {
        ...
        }), /* Cannot get final name for export "tap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (inRange) {
          if (inRange) {
            if (_this2.mouseEvents) _this2.contentEl.classList.add("hy-drawer-grabbing");
            _this2.prepareInteraction();
          }
        }), /* Cannot get final name for export "share" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined());

        // #### End observable
        // The observable of all relevant "end" events, i.e. the last `touchend` (or `mouseup`),
        var end$ = this.getEndObservable().pipe(/* Cannot get final name for export "takeUntil" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(this.subjects.disconnect), /* Cannot get final name for export "filterWhen" in "./node_modules/hy-drawer/src/mixin/setup.js" (known exports: setupObservablesMixin, known reexports: ) */ undefined(active$, isInRange$), /* Cannot get final name for export "share" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined());

        // #### Move observable
        // The observable of all relevant "move" events.
        var move$ = this.getMoveObservable(start$, end$).pipe(/* Cannot get final name for export "takeUntil" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(this.subjects.disconnect), /* Cannot get final name for export "filterWhen" in "./node_modules/hy-drawer/src/mixin/setup.js" (known exports: setupObservablesMixin, known reexports: ) */ undefined(active$, isInRange$), /* Cannot get final name for export "share" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined());
        ...
        var isSliding$ = this.getIsSlidingObservable(move$, start$, end$).pipe(/* Cannot get final name for export "tap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (isSliding) {
        ...
        this.translateX$ = /* Cannot get final name for export "defer" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(function () {
          return /* Cannot get final name for export "merge" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(
          // 1)
          ...
          move$.pipe(/* Cannot get final name for export "filterWhen" in "./node_modules/hy-drawer/src/mixin/setup.js" (known exports: setupObservablesMixin, known reexports: ) */ undefined(isSliding$), /* Cannot get final name for export "tap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref3) {
            var event = _ref3.event;

            if (_this2.preventDefault) event.preventDefault();
          }), /* Cannot get final name for export "observeOn" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(/* Cannot get final name for export "animationFrameScheduler" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined),
          ...
          /* Cannot get final name for export "withLatestFrom" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(start$, _this2.startTranslateX$), /* Cannot get final name for export "map" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref4) {
          ...
          /* Cannot get final name for export "combineLatest" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(_this2.subjects.opened, _this2.subjects.align).pipe(
          ...
          /* Cannot get final name for export "tap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref6) {
            var _ref7 = setup__slicedToArray(_ref6, 1),
                opened = _ref7[0];

            return _this2.cleanupInteraction(opened);
          }), /* Cannot get final name for export "map" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref8) {
        ...
        .pipe(/* Cannot get final name for export "takeUntil" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(this.subjects.disconnect), /* Cannot get final name for export "share" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined());
        ...
        this.startTranslateX$ = this.translateX$.pipe(/* Cannot get final name for export "sample" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(start$));
        ...
        var velocity$ = this.translateX$.pipe(/* Cannot get final name for export "timestamp" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(), /* Cannot get final name for export "pairwise" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(),
        ...
        /* Cannot get final name for export "filter" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref10) {
        ...
        /* Cannot get final name for export "startWith" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(0));

        // TODO
        var willOpen$ = end$.pipe(/* Cannot get final name for export "tap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function () {
          return _this2.contentEl.classList.remove("hy-drawer-grabbing");
        }), /* Cannot get final name for export "withLatestFrom" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(start$, this.translateX$, velocity$), /* Cannot get final name for export "filter" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(this.calcIsSwipe.bind(this)), /* Cannot get final name for export "map" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(this.calcWillOpen.bind(this)),
        // TODO: only fire `slideend` event when slidestart fired as well?
        /* Cannot get final name for export "tap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (willOpen) {
        ...
        var tweenTrigger$ = /* Cannot get final name for export "merge" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(willOpen$, this.animateTo$.pipe(/* Cannot get final name for export "tap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(this.prepareInteraction.bind(this))));
        ...
        this.tween$ = tweenTrigger$.pipe(/* Cannot get final name for export "tap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (willOpen) {
        ...
        /* Cannot get final name for export "withLatestFrom" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(this.translateX$), /* Cannot get final name for export "switchMap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref14) {
          ...
          var duration = /* Cannot get final name for export "BASE_DURATION" in "./node_modules/hy-drawer/src/mixin/observables.js" (known exports: baseObservablesMixin, known reexports: ) */ undefined + _this2.drawerWidth * /* Cannot get final name for export "WIDTH_CONTRIBUTION" in "./node_modules/hy-drawer/src/mixin/observables.js" (known exports: baseObservablesMixin, known reexports: ) */ undefined;

          return /* Cannot get final name for export "createTween" in "./node_modules/hy-drawer/src/mixin/calc.js" (known exports: calcMixin, known reexports: ) */ undefined(/* Cannot get final name for export "easeOutSine" in "./node_modules/hy-drawer/src/mixin/update.js" (known exports: updateMixin, known reexports: ) */ undefined, translateX, diffTranslateX, duration).pipe(/* Cannot get final name for export "tap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined({ complete: function complete() {
              return _this2.subjects.opened.next(opened);
            } }), /* Cannot get final name for export "takeUntil" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(start$), /* Cannot get final name for export "takeUntil" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(_this2.subjects.align.pipe(/* Cannot get final name for export "skip" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(1))), /* Cannot get final name for export "share" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined());
        }));
        ...
        /* Cannot get final name for export "fromEvent" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(this.scrimEl, "click").pipe(/* Cannot get final name for export "takeUntil" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(this.subjects.disconnect)).subscribe(function () {
          return _this2.close();
        });

        // Other than preventing sliding, setting `persistent` will also hide the scrim.
        active$.pipe(/* Cannot get final name for export "takeUntil" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(this.subjects.disconnect)).subscribe(function (active) {
          _this2.scrimEl.style.display = active ? "block" : "none";
        });

        // Whenever the alignment of the drawer changes, update the CSS classes.
        this.subjects.align.pipe(/* Cannot get final name for export "takeUntil" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(this.subjects.disconnect)).subscribe(function (align) {
        ...
        this.subjects.mouseEvents.pipe(/* Cannot get final name for export "takeUntil" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(this.subjects.disconnect), /* Cannot get final name for export "switchMap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (mouseEvents) {
          if (mouseEvents) _this2.contentEl.classList.add("hy-drawer-grab");else _this2.contentEl.classList.remove("hy-drawer-grab");

          return mouseEvents ? start$.pipe(/* Cannot get final name for export "withLatestFrom" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(isInRange$)) : /* Cannot get final name for export "never" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined();
    ...
    return _class;
  }(/* Cannot get final name for export "baseObservablesMixin" in "./node_modules/hy-component/src/common.js" (known exports: parseType decamelize camelCase, known reexports: ) */ undefined(/* Cannot get final name for export "updateMixin" in "./node_modules/hy-drawer/src/vanilla/index.js" (known exports: VANILLA_FEATURE_TESTS HyDrawer, known reexports: Set) */ undefined(/* Cannot get final name for export "calcMixin" in "./node_modules/hy-drawer/src/mixin/index.js" (known exports: MIXIN_FEATURE_TESTS drawerMixin, known reexports: Set) */ undefined(C))));
};
...
var MIXIN_FEATURE_TESTS = new /* Cannot get final name for export "Set" in "./node_modules/attr-types/array.js" (known exports: array default, known reexports: ) */ undefined([].concat(_toConsumableArray(/* Cannot get final name for export "COMPONENT_FEATURE_TESTS" in "./node_modules/attr-types/array.js" (known exports: array default, known reexports: ) */ undefined), ["eventlistener", "queryselector", "requestanimationframe", "classlist", "opacity", "csstransforms", "csspointerevents"]));
  ...
  return function (_setupObservablesMixi) {
    ...
    mixin__createClass(_class, [{
      ...
      value: function setupComponent(el, props) {
        ...
        this.animateTo$ = new /* Cannot get final name for export "Subject" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined();
      ...
      get: function get() {
        return {
          opened: /* Cannot get final name for export "bool" in "./node_modules/rxjs/_esm5/internal/operators/auditTime.js" (known exports: auditTime, known reexports: ) */ undefined,
          align: /* Cannot get final name for export "oneOf" in "./node_modules/rxjs/_esm5/internal/operators/auditTime.js" (known exports: auditTime, known reexports: ) */ undefined(["left", "right"]),
          persistent: /* Cannot get final name for export "bool" in "./node_modules/rxjs/_esm5/internal/operators/auditTime.js" (known exports: auditTime, known reexports: ) */ undefined,
          range: /* Cannot get final name for export "arrayOf" in "./node_modules/rxjs/_esm5/internal/operators/auditTime.js" (known exports: auditTime, known reexports: ) */ undefined(/* Cannot get final name for export "number" in "./node_modules/rxjs/_esm5/internal/operators/auditTime.js" (known exports: auditTime, known reexports: ) */ undefined),
          threshold: /* Cannot get final name for export "number" in "./node_modules/rxjs/_esm5/internal/operators/auditTime.js" (known exports: auditTime, known reexports: ) */ undefined,
          preventDefault: /* Cannot get final name for export "bool" in "./node_modules/rxjs/_esm5/internal/operators/auditTime.js" (known exports: auditTime, known reexports: ) */ undefined,
          mouseEvents: /* Cannot get final name for export "bool" in "./node_modules/rxjs/_esm5/internal/operators/auditTime.js" (known exports: auditTime, known reexports: ) */ undefined
        };
      }
    }, {
      key: "defaults",
    ...
    return _class;
  }(/* Cannot get final name for export "setupObservablesMixin" in "./node_modules/hy-component/src/custom-element.js" (known exports: CUSTOM_ELEMENT_FEATURE_TESTS customElementMixin CustomElement fragmentFromString, known reexports: Set) */ undefined(/* Cannot get final name for export "rxjsMixin" in "./node_modules/attr-types/array-of.js" (known exports: arrayOf default, known reexports: ) */ undefined(/* Cannot get final name for export "componentMixin" in "./node_modules/attr-types/array.js" (known exports: array default, known reexports: ) */ undefined(C))));
};
...
var VANILLA_FEATURE_TESTS = /* Cannot get final name for export "MIXIN_FEATURE_TESTS" in "./node_modules/hy-drawer/src/webcomponent/template.js" (known exports: template, known reexports: ) */ undefined;
...
var vanilla_HyDrawer = function (_drawerMixin) {
  ...
  vanilla__createClass(HyDrawer, [{
    ...
    value: function setupShadowDOM(el) {
      ...
      df.appendChild(/* Cannot get final name for export "createElement" in "./node_modules/hy-component/src/rxjs.js" (known exports: rxjsMixin, known reexports: ) */ undefined("div", { class: "hy-drawer-scrim" }));
      df.appendChild(/* Cannot get final name for export "createElement" in "./node_modules/hy-component/src/rxjs.js" (known exports: rxjsMixin, known reexports: ) */ undefined("div", { class: "hy-drawer-content" }, el.children));
  ...
  return HyDrawer;
}(/* Cannot get final name for export "drawerMixin" in "./node_modules/hy-drawer/src/webcomponent/template.js" (known exports: template, known reexports: ) */ undefined(/* Cannot get final name for export "VanillaComponent" in "./node_modules/create-element-x/library.js" (known exports: createElement default, known reexports: ) */ undefined));
...
var CUSTOM_ELEMENT_FEATURE_TESTS = new /* Cannot get final name for export "Set" in "./node_modules/create-element-x/factory.js" (known exports: createCreateElement default, known reexports: ) */ undefined([].concat(custom_element__toConsumableArray(/* Cannot get final name for export "COMPONENT_FEATURE_TESTS" in "./node_modules/attr-types/array.js" (known exports: array default, known reexports: ) */ undefined), ["template", "customelements"]));
  ...
  return function (_C) {
    ...
    custom_element__createClass(_class, null, [{
      ...
      value: function getObservedAttributes() {
        ...
        return Object.keys(types).map(function (x) {
          return /* unused reexport */undefined(x);
        });
      }
    }]);
    ...
    custom_element__createClass(_class, [{
      ...
      value: function reflectAttribute(key, val) {
        ...
        var attrName = /* unused reexport */undefined(key);
      ...
      */
      ...
      value: function getStateFromAttributes() {
        ...
        Object.keys(types).forEach(function (key) {
          ...
          var value = /* unused reexport */undefined(types[key], attr);
      ...
      value: function attributeChangedCallback(attrName, oldAttr, attr) {
        if (circutBreaker === attrName) circutBreaker = null;else if (oldAttr !== attr) {
          ...
          var key = /* unused reexport */undefined(attrName);
          var value = /* unused reexport */undefined(types[key], attr);
...
var WEBCOMPONENT_FEATURE_TESTS = new /* Cannot get final name for export "Set" in "./_js/src/drawer.js" (known exports: , known reexports: ) */ undefined([].concat(webcomponent__toConsumableArray(/* Cannot get final name for export "CUSTOM_ELEMENT_FEATURE_TESTS" in "./_js/src/drawer.js" (known exports: , known reexports: ) */ undefined), webcomponent__toConsumableArray(/* Cannot get final name for export "MIXIN_FEATURE_TESTS" in "./node_modules/hy-drawer/src/webcomponent/template.js" (known exports: template, known reexports: ) */ undefined)));
...
var webcomponent_HyDrawerElement = function (_customElementMixin) {
  ...
  webcomponent__createClass(HyDrawerElement, [{
    ...
    value: function getTemplate() {
      return /* Cannot get final name for export "fragmentFromString" in "./_js/src/drawer.js" (known exports: , known reexports: ) */ undefined(/* unused reexport */undefined);
    }
  }], [{
...
}(/* Cannot get final name for export "customElementMixin" in "./_js/src/drawer.js" (known exports: , known reexports: ) */ undefined(/* Cannot get final name for export "drawerMixin" in "./node_modules/hy-drawer/src/webcomponent/template.js" (known exports: template, known reexports: ) */ undefined(/* Cannot get final name for export "CustomElement" in "./_js/src/drawer.js" (known exports: , known reexports: ) */ undefined)));
...
var drawer_REQUIREMENTS = new _Set([].concat(drawer__toConsumableArray(/* Cannot get final name for export "VANILLA_FEATURE_TESTS" in "./node_modules/hy-drawer/src/webcomponent/index.js" (known exports: WEBCOMPONENT_FEATURE_TESTS HyDrawerElement, known reexports: Set) */ undefined), ['cssremunit', 'classlist', 'eventlistener', 'matchmedia']));
...
function getRange() {
  if (/* Cannot get final name for export "isMobileSafari" in "./node_modules/qd-set/esm/index.js" (known exports: Set, known reexports: ) */ undefined && !navigator.standalone) {
    return [35, 135];
  }
  return [0, 150];
}
...
function setupWebComponent(drawerEl) {
  ...
  drawerEl.setAttribute('threshold', /* Cannot get final name for export "isSafari" in "./node_modules/qd-set/esm/index.js" (known exports: Set, known reexports: ) */ undefined ? 0 : 10);
...
function setupVanilla(drawerEl) {
  return new /* Cannot get final name for export "HyDrawer" in "./node_modules/hy-drawer/src/webcomponent/index.js" (known exports: WEBCOMPONENT_FEATURE_TESTS HyDrawerElement, known reexports: Set) */ undefined(drawerEl, {
    opened: window._isDesktop,
    persistent: window._isDesktop,
    align: 'left',
    range: getRange(),
    threshold: /* Cannot get final name for export "isSafari" in "./node_modules/qd-set/esm/index.js" (known exports: Set, known reexports: ) */ undefined ? 0 : 10,
    preventDefault: true
  });
}
...
if (!window._noDrawer && /* Cannot get final name for export "hasFeatures" in "./node_modules/qd-set/esm/index.js" (known exports: Set, known reexports: ) */ undefined(drawer_REQUIREMENTS) && !/* Cannot get final name for export "isUCBrowser" in "./node_modules/qd-set/esm/index.js" (known exports: Set, known reexports: ) */ undefined) {
  ...
  */
  ...
  /* Cannot get final name for export "fromEvent" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(window, 'resize', { passive: true }).subscribe(resizeCallback);
}
...
var operators_unsubscribeWhen = function unsubscribeWhen(pauser$) {
  return function (source) {
    ...
    return pauser$.pipe(/* Cannot get final name for export "switchMap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (paused) {
      return paused ? /* Cannot get final name for export "never" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined() : source;
    }));
  };
};
  ...
  return function (_C) {
    ...
    methods__createClass(_class, [{
      ...
      value: function isPushEvent(_ref) {
        ...
        return !metaKey && !ctrlKey && this.shouldLoadAnchor(anchor, this.hrefRegex) && !/* Cannot get final name for export "isExternal" in "./node_modules/hy-push-state/src/mixin/scrolling.js" (known exports: scrollMixin, known reexports: ) */ undefined(url, this);
      }
    }, {
      key: "isHintEvent",
      value: function isHintEvent(_ref2) {
        ...
        return this.shouldLoadAnchor(anchor, this.hrefRegex) && !/* Cannot get final name for export "isExternal" in "./node_modules/hy-push-state/src/mixin/scrolling.js" (known exports: scrollMixin, known reexports: ) */ undefined(url, this) && !/* Cannot get final name for export "isHash" in "./node_modules/hy-push-state/src/mixin/scrolling.js" (known exports: scrollMixin, known reexports: ) */ undefined(url, this);
      }
      ...
      value: function isHashChange(_ref3) {
        ...
        return pathname === prevPathname && (type === /* Cannot get final name for export "POP" in "./node_modules/hy-push-state/src/mixin/history.js" (known exports: historyMixin, known reexports: ) */ undefined || type === /* Cannot get final name for export "PUSH" in "./node_modules/hy-push-state/src/mixin/history.js" (known exports: historyMixin, known reexports: ) */ undefined && hash !== "");
      }
    }]);
    ...
    scrolling__createClass(_class, [{
      ...
      value: function assignScrollPosition(state) {
        ...
        return Object.assign(state, _defineProperty({}, id, Object.assign(state[id] || {}, {
          scrollTop: /* Cannot get final name for export "getScrollTop" in "./node_modules/hy-push-state/src/mixin/scrolling.js" (known exports: scrollMixin, known reexports: ) */ undefined(),
          scrollHeight: /* Cannot get final name for export "getScrollHeight" in "./node_modules/hy-push-state/src/mixin/scrolling.js" (known exports: scrollMixin, known reexports: ) */ undefined()
        })));
      }
      ...
      value: function manageScrollPostion(_ref) {
        ...
        switch (type) {
          case /* Cannot get final name for export "PUSH" in "./node_modules/hy-push-state/src/mixin/history.js" (known exports: historyMixin, known reexports: ) */ undefined:
            // FIXME: make configurable
            this.scrollHashIntoView(hash, { behavior: "smooth", block: "start", inline: "nearest" });
            break;
          case /* Cannot get final name for export "POP" in "./node_modules/hy-push-state/src/mixin/history.js" (known exports: historyMixin, known reexports: ) */ undefined:
            {
      ...
      value: function restoreScrollPostionOnReload() {
        var userHasScrolled = /* Cannot get final name for export "getScrollTop" in "./node_modules/hy-push-state/src/mixin/scrolling.js" (known exports: scrollMixin, known reexports: ) */ undefined() != 0;
  ...
  return function (_scrollMixin) {
    ...
    history__createClass(_class, [{
      ...
      value: function updateHistoryState(_ref) {
        ...
        if (/* Cannot get final name for export "isExternal" in "./node_modules/hy-push-state/src/mixin/scrolling.js" (known exports: scrollMixin, known reexports: ) */ undefined(this)) return;

        switch (type) {
          case /* Cannot get final name for export "INIT" in "./node_modules/hy-push-state/src/mixin/history.js" (known exports: historyMixin, known reexports: ) */ undefined:
          case /* Cannot get final name for export "PUSH" in "./node_modules/hy-push-state/src/mixin/history.js" (known exports: historyMixin, known reexports: ) */ undefined:
            {
              var id = this.histId();
      ...
      value: function updateHistoryStateHash(_ref2) {
        ...
        if (/* Cannot get final name for export "isExternal" in "./node_modules/hy-push-state/src/mixin/scrolling.js" (known exports: scrollMixin, known reexports: ) */ undefined(this)) return; // TODO: abort or not?

        if (type === /* Cannot get final name for export "PUSH" in "./node_modules/hy-push-state/src/mixin/history.js" (known exports: historyMixin, known reexports: ) */ undefined) {
          var id = this.histId();
      ...
      value: function updateHistoryTitle(_ref3) {
        ...
        if (!/* Cannot get final name for export "isExternal" in "./node_modules/hy-push-state/src/mixin/scrolling.js" (known exports: scrollMixin, known reexports: ) */ undefined(this) && type === /* Cannot get final name for export "PUSH" in "./node_modules/hy-push-state/src/mixin/history.js" (known exports: historyMixin, known reexports: ) */ undefined) window.history.replaceState(window.history.state, title, window.location);
      }
    }, {
    ...
    return _class;
  }(/* Cannot get final name for export "scrollMixin" in "./node_modules/rxjs/_esm5/internal/util/tryCatch.js" (known exports: tryCatch, known reexports: ) */ undefined(C));
};
...
function getCORSRequest() {
    if (/* Cannot get final name for export "root" in "./node_modules/rxjs/_esm5/internal/observable/dom/ajax.js" (known exports: ajax, known reexports: ) */ undefined.XMLHttpRequest) {
        return new /* Cannot get final name for export "root" in "./node_modules/rxjs/_esm5/internal/observable/dom/ajax.js" (known exports: ajax, known reexports: ) */ undefined.XMLHttpRequest();
    } else if (!!/* Cannot get final name for export "root" in "./node_modules/rxjs/_esm5/internal/observable/dom/ajax.js" (known exports: ajax, known reexports: ) */ undefined.XDomainRequest) {
        return new /* Cannot get final name for export "root" in "./node_modules/rxjs/_esm5/internal/observable/dom/ajax.js" (known exports: ajax, known reexports: ) */ undefined.XDomainRequest();
    } else {
    ...
    if (/* Cannot get final name for export "root" in "./node_modules/rxjs/_esm5/internal/observable/dom/ajax.js" (known exports: ajax, known reexports: ) */ undefined.XMLHttpRequest) {
        ...
        try {
            ...
            for (var i = 0; i < 3; i++) {
                try {
                    progId = progIds[i];
                    if (new /* Cannot get final name for export "root" in "./node_modules/rxjs/_esm5/internal/observable/dom/ajax.js" (known exports: ajax, known reexports: ) */ undefined.ActiveXObject(progId)) {
                        break;
                    }
                } catch (e) {}
            }
            return new /* Cannot get final name for export "root" in "./node_modules/rxjs/_esm5/internal/observable/dom/ajax.js" (known exports: ajax, known reexports: ) */ undefined.ActiveXObject(progId);
        } catch (e) {
...
var AjaxObservable_AjaxSubscriber = /*@__PURE__*/function (_super) {
    ...
    function AjaxSubscriber(destination, request) {
        ...
        if (!('Content-Type' in headers) && !(/* Cannot get final name for export "root" in "./node_modules/rxjs/_esm5/internal/observable/dom/ajax.js" (known exports: ajax, known reexports: ) */ undefined.FormData && request.body instanceof /* Cannot get final name for export "root" in "./node_modules/rxjs/_esm5/internal/observable/dom/ajax.js" (known exports: ajax, known reexports: ) */ undefined.FormData) && typeof request.body !== 'undefined') {
    ...
    AjaxSubscriber.prototype.send = function () {
        ...
        var xhr = /* Cannot get final name for export "tryCatch" in "./node_modules/rxjs/_esm5/internal/Subscription.js" (known exports: Subscription, known reexports: ) */ undefined(createXHR).call(request);
        if (xhr === /* Cannot get final name for export "errorObject" in "./node_modules/rxjs/_esm5/internal/util/UnsubscriptionError.js" (known exports: UnsubscriptionError, known reexports: ) */ undefined) {
            this.error(/* Cannot get final name for export "errorObject" in "./node_modules/rxjs/_esm5/internal/util/UnsubscriptionError.js" (known exports: UnsubscriptionError, known reexports: ) */ undefined.e);
        } else {
            this.xhr = xhr;
            this.setupEvents(xhr, request);
            var result = void 0;
            if (user) {
                result = /* Cannot get final name for export "tryCatch" in "./node_modules/rxjs/_esm5/internal/Subscription.js" (known exports: Subscription, known reexports: ) */ undefined(xhr.open).call(xhr, method, url, async, user, password);
            } else {
                result = /* Cannot get final name for export "tryCatch" in "./node_modules/rxjs/_esm5/internal/Subscription.js" (known exports: Subscription, known reexports: ) */ undefined(xhr.open).call(xhr, method, url, async);
            }
            if (result === /* Cannot get final name for export "errorObject" in "./node_modules/rxjs/_esm5/internal/util/UnsubscriptionError.js" (known exports: UnsubscriptionError, known reexports: ) */ undefined) {
                this.error(/* Cannot get final name for export "errorObject" in "./node_modules/rxjs/_esm5/internal/util/UnsubscriptionError.js" (known exports: UnsubscriptionError, known reexports: ) */ undefined.e);
                return null;
            }
            if (async) {
            ...
            result = body ? /* Cannot get final name for export "tryCatch" in "./node_modules/rxjs/_esm5/internal/Subscription.js" (known exports: Subscription, known reexports: ) */ undefined(xhr.send).call(xhr, body) : /* Cannot get final name for export "tryCatch" in "./node_modules/rxjs/_esm5/internal/Subscription.js" (known exports: Subscription, known reexports: ) */ undefined(xhr.send).call(xhr);
            if (result === /* Cannot get final name for export "errorObject" in "./node_modules/rxjs/_esm5/internal/util/UnsubscriptionError.js" (known exports: UnsubscriptionError, known reexports: ) */ undefined) {
                this.error(/* Cannot get final name for export "errorObject" in "./node_modules/rxjs/_esm5/internal/util/UnsubscriptionError.js" (known exports: UnsubscriptionError, known reexports: ) */ undefined.e);
                return null;
            }
    ...
    AjaxSubscriber.prototype.serializeBody = function (body, contentType) {
        if (!body || typeof body === 'string') {
            return body;
        } else if (/* Cannot get final name for export "root" in "./node_modules/rxjs/_esm5/internal/observable/dom/ajax.js" (known exports: ajax, known reexports: ) */ undefined.FormData && body instanceof /* Cannot get final name for export "root" in "./node_modules/rxjs/_esm5/internal/observable/dom/ajax.js" (known exports: ajax, known reexports: ) */ undefined.FormData) {
            return body;
        }
        if (contentType) {
    ...
    AjaxSubscriber.prototype.setupEvents = function (xhr, request) {
        ...
        if (xhr.upload && 'withCredentials' in xhr) {
            if (progressSubscriber) {
                ...
                if (/* Cannot get final name for export "root" in "./node_modules/rxjs/_esm5/internal/observable/dom/ajax.js" (known exports: ajax, known reexports: ) */ undefined.XDomainRequest) {
...
var ajax = /* Cannot get final name for export "AjaxObservable" in "./node_modules/rxjs/_esm5/ajax/index.js" (known exports: , known reexports: ajax AjaxResponse AjaxError AjaxTimeoutError) */ undefined.create;
  ...
  return function (_C) {
    ...
    fetching__createClass(_class, [{
      ...
      value: function makeRequest(context) {
        ...
        return /* Cannot get final name for export "ajax" in "./node_modules/hy-push-state/src/mixin/script-hack.js" (known exports: scriptMixin, known reexports: ) */ undefined({
          method: "GET",
          responseType: "text",
          url: context.url,
          crossDomain: /* Cannot get final name for export "isExternal" in "./node_modules/hy-push-state/src/mixin/scrolling.js" (known exports: scrollMixin, known reexports: ) */ undefined(this),
          headers: { Accept: "text/html" }
        }).pipe(/* Cannot get final name for export "map" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref) {
          var response = _ref.response;
          return Object.assign(context, { response: response });
        }), /* Cannot get final name for export "catchError" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (error) {
      ...
      value: function recoverIfResponse(context, error) {
        ...
        if (xhr && xhr.response && status > 400 && status < 598) {
          return /* Cannot get final name for export "of" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(Object.assign(context, { response: xhr.response }));
        }

        // If we don't have a response, this is an acutal error that should be dealt with.
        return /* Cannot get final name for export "of" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(Object.assign(context, { error: error }));
      }
      ...
      value: function getFetch$(_ref2, latestPrefetch, prefetch$) {
        ...
        return href === latestPrefetch.url.href && latestPrefetch.error == null ? /* Cannot get final name for export "of" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(latestPrefetch) : prefetch$.pipe(/* Cannot get final name for export "take" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(1));
      }
      ...
      value: function getResponse(prefetch$, _ref3) {
        ...
        return /* Cannot get final name for export "zip" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(this.getFetch$(context, latestPrefetch, prefetch$).pipe(/* Cannot get final name for export "map" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (fetch) {
  ...
  return function (_C) {
    ...
    script_hack__createClass(_class, [{
      ...
      value: function insertScript(_ref) {
        ...
        return script.src !== "" ? /* Cannot get final name for export "Observable" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined.create(function (observer) {
        ...
        /* Cannot get final name for export "of" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined({}).pipe(/* Cannot get final name for export "tap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function () {
          ref.parentNode.insertBefore(script, ref.nextSibling);
          document.write = originalWrite;
        }));
      }
      ...
      value: function reinsertScriptTags(context) {
        if (!this.scriptSelector) return /* Cannot get final name for export "of" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(context);

        var scripts = context.scripts;


        return /* Cannot get final name for export "from" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(scripts).pipe(/* Cannot get final name for export "concatMap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(this.insertScript.bind(this)), /* Cannot get final name for export "catchError" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (error) {
  ...
  return function (_scriptMixin) {
    ...
    mixin_update__createClass(_class, [{
      ...
      value: function responseToContent(context) {
        ...
        var fragment = /* Cannot get final name for export "fragmentFromString" in "./node_modules/hy-push-state/src/mixin/scrolling.js" (known exports: scrollMixin, known reexports: ) */ undefined(response);
      ...
      value: function updateDOM(context) {
        try {
          ...
          if (/* Cannot get final name for export "isExternal" in "./node_modules/hy-push-state/src/mixin/scrolling.js" (known exports: scrollMixin, known reexports: ) */ undefined(this)) this.rewriteURLs(replaceEls);
    ...
    return _class;
  }(/* Cannot get final name for export "scriptMixin" in "./node_modules/hy-push-state/src/mixin/events.js" (known exports: eventMixin, known reexports: ) */ undefined(C));
};
  ...
  return function (_C) {
    ...
    events__createClass(_class, [{
      ...
      value: function onStart(context) {
        ...
        this.animPromise = /* Cannot get final name for export "timer" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(this.duration);
        ...
        var waitUntil = function waitUntil(promise) {
          if (true && !(promise instanceof Promise || promise instanceof /* Cannot get final name for export "Observable" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined)) {
        ...
        if ("MutationObserver" in window && "WeakSet" in window) {
          ...
          var addListeners = function addListeners(addedNode) {
            if (addedNode instanceof Element) {
              if (/* Cannot get final name for export "matches" in "./node_modules/hy-push-state/src/mixin/scrolling.js" (known exports: scrollMixin, known reexports: ) */ undefined.call(addedNode, _this2.linkSelector)) {
                addLink(addedNode);
              } else {
          ...
          var removeListeners = function removeListeners(removedNode) {
            if (removedNode instanceof Element) {
              if (/* Cannot get final name for export "matches" in "./node_modules/hy-push-state/src/mixin/scrolling.js" (known exports: scrollMixin, known reexports: ) */ undefined.call(removedNode, _this2.linkSelector)) {
          ...
          /* Cannot get final name for export "Observable" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined.create(function (obs) {
          ...
          this.el.addEventListener("click", function (event) {
            var anchor = /* Cannot get final name for export "matchesAncestors" in "./node_modules/hy-push-state/src/mixin/scrolling.js" (known exports: scrollMixin, known reexports: ) */ undefined.call(event.target, _this2.linkSelector);
  ...
  return function (_eventListenersMixin) {
    ...
    mixin_setup__createClass(_class, [{
      ...
      value: function setupObservables() {
        ...
        this.pushSubject = new /* Cannot get final name for export "Subject" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined();
        this.hintSubject = new /* Cannot get final name for export "Subject" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined();

        // TODO: doc
        var push$ = this.pushSubject.pipe(/* Cannot get final name for export "takeUntil" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(this.subjects.disconnect), /* Cannot get final name for export "map" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (event) {
          return {
            type: /* Cannot get final name for export "PUSH" in "./node_modules/hy-push-state/src/mixin/history.js" (known exports: historyMixin, known reexports: ) */ undefined,
            url: new /* Cannot get final name for export "URL" in "./node_modules/hy-push-state/src/mixin/methods.js" (known exports: helperMixin, known reexports: ) */ undefined(event.currentTarget.href, _this2.href),
            anchor: event.currentTarget,
            event: event,
            cacheNr: _this2.cacheNr
          };
        }), /* Cannot get final name for export "filter" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(this.isPushEvent.bind(this)), /* Cannot get final name for export "tap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref) {
        ...
        var pop$ = /* Cannot get final name for export "fromEvent" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(window, "popstate").pipe(/* Cannot get final name for export "takeUntil" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(this.subjects.disconnect), /* Cannot get final name for export "filter" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function () {
          return window.history.state && window.history.state[_this2.histId()];
        }), /* Cannot get final name for export "map" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (event) {
          return {
            type: /* Cannot get final name for export "POP" in "./node_modules/hy-push-state/src/mixin/history.js" (known exports: historyMixin, known reexports: ) */ undefined,
            url: new /* Cannot get final name for export "URL" in "./node_modules/hy-push-state/src/mixin/methods.js" (known exports: helperMixin, known reexports: ) */ undefined(window.location, _this2.href),
            event: event,
            cacheNr: _this2.cacheNr
          };
        }));

        var reload$ = this.reload$.pipe(/* Cannot get final name for export "takeUntil" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(this.subjects.disconnect));

        // TODO: doc

        var _merge$pipe$map = /* Cannot get final name for export "merge" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(push$, pop$, reload$).pipe(/* Cannot get final name for export "startWith" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined({ url: new /* Cannot get final name for export "URL" in "./node_modules/hy-push-state/src/mixin/methods.js" (known exports: helperMixin, known reexports: ) */ undefined(this.initialHref) }),
        // HACK: make hy-push-state mimic window.location?
        /* Cannot get final name for export "tap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref2) {
          var url = _ref2.url;
          return _this2._url = url;
        }), /* Cannot get final name for export "pairwise" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(), /* Cannot get final name for export "share" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(), /* Cannot get final name for export "partition" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(this.isHashChange)).map(function (obs$) {
          return obs$.pipe(/* Cannot get final name for export "map" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref3) {
        ...
        var pauser$ = /* Cannot get final name for export "defer" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(function () {
          return (
            // A page change event means we want to pause prefetching, while
            // a response event means we want to resume prefetching.
            /* Cannot get final name for export "merge" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(page$.pipe(/* Cannot get final name for export "mapTo" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(true)), _this2.fetch$.pipe(/* Cannot get final name for export "mapTo" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(false)))
          );
        })
        // Start with `false`, i.e. we want the prefetch pipelien to be active
        .pipe(/* Cannot get final name for export "startWith" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(false), /* Cannot get final name for export "share" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined());

        // TODO: doc
        var hint$ = this.hintSubject.pipe(/* Cannot get final name for export "takeUntil" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(this.subjects.disconnect), /* unused reexport */undefined(pauser$), /* Cannot get final name for export "map" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (event) {
          return {
            type: /* Cannot get final name for export "HINT" in "./node_modules/hy-push-state/src/mixin/history.js" (known exports: historyMixin, known reexports: ) */ undefined,
            url: new /* Cannot get final name for export "URL" in "./node_modules/hy-push-state/src/mixin/methods.js" (known exports: helperMixin, known reexports: ) */ undefined(event.currentTarget.href, _this2.href),
            anchor: event.currentTarget,
            event: event,
            cacheNr: _this2.cacheNr
          };
        }), /* Cannot get final name for export "filter" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(this.isHintEvent.bind(this)));

        // The stream of (pre-)fetch events.
        // Includes definitive page change events do deal with unexpected page changes.
        var prefetch$ = /* Cannot get final name for export "merge" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(hint$, page$).pipe(
        // Don't abort a request if the user "jiggles" over a link
        /* Cannot get final name for export "distinctUntilChanged" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(this.compareContext.bind(this)), /* Cannot get final name for export "switchMap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(this.makeRequest.bind(this)),
        // Start with some value so `withLatestFrom` below doesn't "block"
        /* Cannot get final name for export "startWith" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined({ url: {} }), /* Cannot get final name for export "share" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined());

        // TODO: doc
        this.fetch$ = page$.pipe(/* Cannot get final name for export "tap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (context) {
          _this2.updateHistoryState(context);
          _this2.onStart(context);
        }), /* Cannot get final name for export "withLatestFrom" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(prefetch$), /* Cannot get final name for export "switchMap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(this.getResponse.bind(this, prefetch$)), /* Cannot get final name for export "share" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined());

        // TODO: doc

        var _fetch$$pipe = this.fetch$.pipe(/* Cannot get final name for export "partition" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref5) {
        ...
        var main$ = fetchOk$.pipe(/* Cannot get final name for export "map" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(this.responseToContent.bind(this)), /* Cannot get final name for export "tap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (context) {
          _this2.onReady(context);
          _this2.updateDOM(context);
          _this2.onAfter(context);
          _this2.manageScrollPostion(context);
        }), /* Cannot get final name for export "tap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined({ error: function error(e) {
            return _this2.onDOMError(e);
          } }), /* Cannot get final name for export "catchError" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (e, c) {
          return c;
        }),
        ...
        /* Cannot get final name for export "switchMap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(this.reinsertScriptTags.bind(this)), /* Cannot get final name for export "tap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined({ error: function error(e) {
        ...
        page$.pipe(/* Cannot get final name for export "switchMap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (context) {
          return /* Cannot get final name for export "defer" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(function () {
            return _this2.animPromise;
          }).pipe(/* Cannot get final name for export "takeUntil" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(_this2.fetch$), /* Cannot get final name for export "mapTo" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(context));
    ...
    return _class;
  }(/* Cannot get final name for export "eventListenersMixin" in "./node_modules/hy-push-state/src/mixin/index.js" (known exports: MIXIN_FEATURE_TESTS pushStateMixin, known reexports: INIT HINT PUSH POP Set) */ undefined(/* Cannot get final name for export "eventMixin" in "./node_modules/hy-push-state/src/mixin/setup.js" (known exports: setupObservablesMixin, known reexports: ) */ undefined(/* Cannot get final name for export "updateMixin" in "./node_modules/hy-push-state/src/mixin/event-listeners.js" (known exports: eventListenersMixin, known reexports: ) */ undefined(/* Cannot get final name for export "fetchMixin" in "./node_modules/hy-push-state/src/mixin/update.js" (known exports: updateMixin, known reexports: ) */ undefined(/* Cannot get final name for export "historyMixin" in "./node_modules/rxjs/_esm5/internal/observable/dom/AjaxObservable.js" (known exports: ajaxGet ajaxPost ajaxDelete ajaxPut ajaxPatch ajaxGetJSON AjaxObservable AjaxSubscriber AjaxResponse AjaxError AjaxTimeoutError, known reexports: ) */ undefined(/* Cannot get final name for export "helperMixin" in "./node_modules/rxjs/_esm5/internal/util/errorObject.js" (known exports: errorObject, known reexports: ) */ undefined(C)))))));
};
...
var mixin_MIXIN_FEATURE_TESTS = new /* Cannot get final name for export "Set" in "./node_modules/attr-types/array.js" (known exports: array default, known reexports: ) */ undefined([].concat(mixin__toConsumableArray(/* Cannot get final name for export "COMPONENT_FEATURE_TESTS" in "./node_modules/attr-types/array.js" (known exports: array default, known reexports: ) */ undefined), ["documentfragment", "eventlistener", "history", "promises", "queryselector", "requestanimationframe"]));
  ...
  return function (_setupObservablesMixi) {
    ...
    src_mixin__createClass(_class, [{
      ...
      value: function setupComponent(el, props) {
        ...
        this.reload$ = new /* Cannot get final name for export "Subject" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined();
      }
      ...
      value: function connectComponent() {
        ...
        var url = new /* Cannot get final name for export "URL" in "./node_modules/hy-push-state/src/mixin/methods.js" (known exports: helperMixin, known reexports: ) */ undefined(this.initialHref);
        this.updateHistoryState({ type: /* Cannot get final name for export "INIT" in "./node_modules/hy-push-state/src/mixin/history.js" (known exports: historyMixin, known reexports: ) */ undefined, replace: true, url: url });
        ...
        this.onLoad({
          type: /* Cannot get final name for export "INIT" in "./node_modules/hy-push-state/src/mixin/history.js" (known exports: historyMixin, known reexports: ) */ undefined,
      ...
      value: function assign(url) {
        this.reload$.next({
          type: /* Cannot get final name for export "PUSH" in "./node_modules/hy-push-state/src/mixin/history.js" (known exports: historyMixin, known reexports: ) */ undefined,
          url: new /* Cannot get final name for export "URL" in "./node_modules/hy-push-state/src/mixin/methods.js" (known exports: helperMixin, known reexports: ) */ undefined(url, this.href),
      ...
      value: function reload() {
        this.reload$.next({
          type: /* Cannot get final name for export "PUSH" in "./node_modules/hy-push-state/src/mixin/history.js" (known exports: historyMixin, known reexports: ) */ undefined,
          url: new /* Cannot get final name for export "URL" in "./node_modules/hy-push-state/src/mixin/methods.js" (known exports: helperMixin, known reexports: ) */ undefined(this.href),
          cacheNr: ++this.cacheNr, // eslint-disable-line no-plusplus
          replace: true
        });
      }
      ...
      get: function get() {
        return {
          replaceIds: /* Cannot get final name for export "array" in "./node_modules/rxjs/_esm5/internal/operators/auditTime.js" (known exports: auditTime, known reexports: ) */ undefined,
          linkSelector: /* Cannot get final name for export "string" in "./node_modules/rxjs/_esm5/internal/operators/auditTime.js" (known exports: auditTime, known reexports: ) */ undefined,
          duration: /* Cannot get final name for export "number" in "./node_modules/rxjs/_esm5/internal/operators/auditTime.js" (known exports: auditTime, known reexports: ) */ undefined,
          hrefRegex: /* Cannot get final name for export "regex" in "./node_modules/rxjs/_esm5/internal/operators/auditTime.js" (known exports: auditTime, known reexports: ) */ undefined,
          scriptSelector: /* Cannot get final name for export "string" in "./node_modules/rxjs/_esm5/internal/operators/auditTime.js" (known exports: auditTime, known reexports: ) */ undefined,
          initialHref: /* Cannot get final name for export "string" in "./node_modules/rxjs/_esm5/internal/operators/auditTime.js" (known exports: auditTime, known reexports: ) */ undefined
        };
      }
    }, {
      key: "defaults",
    ...
    return _class;
  }(/* Cannot get final name for export "setupObservablesMixin" in "./node_modules/hy-push-state/src/vanilla/index.js" (known exports: VANILLA_FEATURE_TESTS HyPushState, known reexports: Set) */ undefined(/* Cannot get final name for export "rxjsMixin" in "./node_modules/attr-types/array-of.js" (known exports: arrayOf default, known reexports: ) */ undefined(/* Cannot get final name for export "componentMixin" in "./node_modules/attr-types/array.js" (known exports: array default, known reexports: ) */ undefined(C))));
};
...
var vanilla_VANILLA_FEATURE_TESTS = /* Cannot get final name for export "MIXIN_FEATURE_TESTS" in "./node_modules/hy-push-state/src/webcomponent/index.js" (known exports: WEBCOMPONENT_FEATURE_TESTS HyPushStateElement, known reexports: Set) */ undefined;
...
var HyPushState = function (_pushStateMixin) {
  ...
  return HyPushState;
}(/* Cannot get final name for export "pushStateMixin" in "./node_modules/hy-push-state/src/webcomponent/index.js" (known exports: WEBCOMPONENT_FEATURE_TESTS HyPushStateElement, known reexports: Set) */ undefined(/* Cannot get final name for export "VanillaComponent" in "./node_modules/create-element-x/library.js" (known exports: createElement default, known reexports: ) */ undefined));
...
var webcomponent_WEBCOMPONENT_FEATURE_TESTS = new /* Cannot get final name for export "Set" in "./_js/src/drawer.js" (known exports: , known reexports: ) */ undefined([].concat(src_webcomponent__toConsumableArray(/* Cannot get final name for export "CUSTOM_ELEMENT_FEATURE_TESTS" in "./_js/src/drawer.js" (known exports: , known reexports: ) */ undefined), src_webcomponent__toConsumableArray(/* Cannot get final name for export "MIXIN_FEATURE_TESTS" in "./node_modules/hy-push-state/src/webcomponent/index.js" (known exports: WEBCOMPONENT_FEATURE_TESTS HyPushStateElement, known reexports: Set) */ undefined)));
...
}(/* Cannot get final name for export "customElementMixin" in "./_js/src/drawer.js" (known exports: , known reexports: ) */ undefined(/* Cannot get final name for export "pushStateMixin" in "./node_modules/hy-push-state/src/webcomponent/index.js" (known exports: WEBCOMPONENT_FEATURE_TESTS HyPushStateElement, known reexports: Set) */ undefined(/* Cannot get final name for export "CustomElement" in "./_js/src/drawer.js" (known exports: , known reexports: ) */ undefined)));
...
function cacheImage$(_ref3) {
  ...
  if (background || !image || image === '' || image === 'none' || image === this.prevImage) {
    return /* Cannot get final name for export "of" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined({});
  }

  var imgObj = new Image();
  var image$ = /* Cannot get final name for export "fromEvent" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(imgObj, 'load').pipe(/* Cannot get final name for export "take" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(1), /* Cannot get final name for export "finalize" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function () {
    imgObj.src = '';
  }));
  imgObj.src = image;
...
var cross_fader_CrossFader = function () {
  function CrossFader(fadeDuration) {
    ...
    this.prevHash = pseudoHash(loadDisqus(main));
  ...
  cross_fader__createClass(CrossFader, [{
    ...
    value: function fetchImage(main) {
      ...
      if (hash === this.prevHash) return /* Cannot get final name for export "empty" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined();

      return cacheImage$.call(this, dataset).pipe(/* Cannot get final name for export "map" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function () {
    ...
    value: function fade(_ref4, _ref5) {
      ...
      return /* Cannot get final name for export "animate" in "./node_modules/qd-set/esm/index.js" (known exports: Set, known reexports: ) */ undefined(div, [{ opacity: 0 }, { opacity: 1 }], {
        duration: this.fadeDuration
      }).pipe(/* Cannot get final name for export "finalize" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function () {
...
function setupFLIPTitle(start$, ready$, fadeIn$, _ref) {
  ...
  var flip$ = start$.pipe(/* Cannot get final name for export "filter" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref2) {
    var flipType = _ref2.flipType;
    return flipType === 'title';
  }), /* Cannot get final name for export "switchMap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref3) {
    var anchor = _ref3.anchor;

    if (!anchor) return /* Cannot get final name for export "of" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined({});
    ...
    if (!page) return /* Cannot get final name for export "of" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined({});
    /* Cannot get final name for export "empty" in "./node_modules/qd-set/esm/index.js" (known exports: Set, known reexports: ) */ undefined.call(page);
    ...
    return /* Cannot get final name for export "animate" in "./node_modules/qd-set/esm/index.js" (known exports: Set, known reexports: ) */ undefined(title, transform, settings).pipe(/* Cannot get final name for export "tap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined({
      complete: function complete() {
  ...
  start$.pipe(/* Cannot get final name for export "switchMap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref4) {
    var flipType = _ref4.flipType;
    return ready$.pipe(/* Cannot get final name for export "filter" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function () {
      return flipType === 'title';
    }), /* Cannot get final name for export "map" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref5) {
      ...
      return title;
    }), /* Cannot get final name for export "zip" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(fadeIn$, function (x) {
      return x;
    }), /* Cannot get final name for export "tap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (title) {
      if (title) title.style.opacity = 1;
      animationMain.style.opacity = 0;
    }), /* Cannot get final name for export "finalize" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function () {
      animationMain.style.opacity = 0;
    }));
  })).subscribe();
...
function setupFLIP(start$, ready$, fadeIn$, options) {
  var other$ = start$.pipe(/* Cannot get final name for export "filter" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref) {
    var flipType = _ref.flipType;
    return !FLIP_TYPES.includes(flipType);
  }));

  return /* Cannot get final name for export "merge" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(/* Cannot get final name for export "default" in "./_js/src/push-state.js" (known exports: , known reexports: ) */ undefined(start$, ready$, fadeIn$, options), other$);
}
...
var push_state_REQUIREMENTS = new /* unused reexport */undefined([].concat(push_state__toConsumableArray(/* unused reexport */undefined), ['classlist', 'cssanimations', 'cssremunit', 'documentfragment', 'eventlistener', 'history', 'matchmedia', 'opacity', 'queryselector', 'requestanimationframe']));
...
function shouldAnimate(type) {
  return type === 'push' || navigator.standalone || !/* Cannot get final name for export "isSafari" in "./node_modules/qd-set/esm/index.js" (known exports: Set, known reexports: ) */ undefined;
}
...
function shouldRestoreScroll() {
  if (/* Cannot get final name for export "isSafari" in "./node_modules/qd-set/esm/index.js" (known exports: Set, known reexports: ) */ undefined) {
...
function animateFadeOut(_ref2) {
  ...
  return shouldAnimate(type) ? /* Cannot get final name for export "animate" in "./node_modules/qd-set/esm/index.js" (known exports: Set, known reexports: ) */ undefined(main, FADE_OUT, SETTINGS).pipe(/* Cannot get final name for export "mapTo" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined({ main: main })) : /* Cannot get final name for export "of" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined({ main: main });
}
...
function animateFadeIn(_ref3) {
  ...
  return shouldAnimate(type) ? /* Cannot get final name for export "animate" in "./node_modules/qd-set/esm/index.js" (known exports: Set, known reexports: ) */ undefined(main, FADE_IN, SETTINGS).pipe(/* Cannot get final name for export "mapTo" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined({ main: main, flipType: flipType })) : /* Cannot get final name for export "of" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined({ main: main, flipType: flipType });
}
...
function push_state_setupVanilla(pushStateEl) {
  return new /* unused reexport */undefined(pushStateEl, {
...
if (!window._noPushState && /* Cannot get final name for export "hasFeatures" in "./node_modules/qd-set/esm/index.js" (known exports: Set, known reexports: ) */ undefined(push_state_REQUIREMENTS) && !/* Cannot get final name for export "isFirefoxIOS" in "./node_modules/qd-set/esm/index.js" (known exports: Set, known reexports: ) */ undefined) {
  // ### Setup
  ...
  var push_state_start$ = /* Cannot get final name for export "fromEvent" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(push_state_pushStateEl, 'hy-push-state-start').pipe(/* Cannot get final name for export "map" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref4) {
    var detail = _ref4.detail;
    return push_state_assign(detail, { flipType: getFlipType(detail.anchor) });
  }), /* Cannot get final name for export "share" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined());

  var push_state_ready$ = /* Cannot get final name for export "fromEvent" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(push_state_pushStateEl, 'hy-push-state-ready').pipe(/* Cannot get final name for export "map" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref5) {
    var detail = _ref5.detail;
    return detail;
  }), /* Cannot get final name for export "share" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined());

  var after$ = /* Cannot get final name for export "fromEvent" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(push_state_pushStateEl, 'hy-push-state-after').pipe(/* Cannot get final name for export "map" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref6) {
    var detail = _ref6.detail;
    return detail;
  }), /* Cannot get final name for export "share" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined());

  var progress$ = /* Cannot get final name for export "fromEvent" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(push_state_pushStateEl, 'hy-push-state-progress').pipe(/* Cannot get final name for export "map" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref7) {
    var detail = _ref7.detail;
    return detail;
  }), /* Cannot get final name for export "share" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined());

  var error$ = /* Cannot get final name for export "fromEvent" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(push_state_pushStateEl, 'hy-push-state-networkerror').pipe(/* Cannot get final name for export "map" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref8) {
  ...
  var fadeOut$ = push_state_start$.pipe(/* Cannot get final name for export "map" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (context) {
  ...
  /* Cannot get final name for export "tap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref9) {
    var type = _ref9.type,
        main = _ref9.main;
  ...
  /* Cannot get final name for export "exhaustMap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(animateFadeOut),

  // After the animation is complete, we empty the current content and scroll to the top.
  /* Cannot get final name for export "tap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref10) {
    var main = _ref10.main;

    /* Cannot get final name for export "empty" in "./node_modules/qd-set/esm/index.js" (known exports: Set, known reexports: ) */ undefined.call(main);
    window.scroll(window.pageXOffset, 0);
  }), /* Cannot get final name for export "share" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined());
  ...
  var push_state_fadeIn$ = after$.pipe(/* Cannot get final name for export "switchMap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(animateFadeIn), /* Cannot get final name for export "tap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref12) {
  ...
  var push_state_flip$ = /* Cannot get final name for export "default" in "./_js/src/index.js" (known exports: , known reexports: ) */ undefined(push_state_start$, push_state_ready$, /* Cannot get final name for export "merge" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(push_state_fadeIn$, error$), {
    animationMain: push_state_animationMain,
    settings: SETTINGS
  }).pipe(/* Cannot get final name for export "share" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined());

  push_state_start$.pipe(/* Cannot get final name for export "map" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (context) {
    var promise = /* Cannot get final name for export "getResolvablePromise" in "./node_modules/qd-set/esm/index.js" (known exports: Set, known reexports: ) */ undefined();
    context.waitUntil(promise);
    return promise;
  }),
  // Every click starts a timer that lasts as long
  // as it takes for the FLIP and fade-out animations to complete.
  /* Cannot get final name for export "switchMap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (p) {
    return /* Cannot get final name for export "timer" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(DURATION).pipe(/* Cannot get final name for export "zip" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(fadeOut$, push_state_flip$, function () {
      return p;
    }));
  })
  ...
  var crossFader = new /* unused reexport */undefined(FADE_DURATION);
  ...
  after$.pipe(/* Cannot get final name for export "switchMap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref13) {
    var _ref13$replaceEls = push_state__slicedToArray(_ref13.replaceEls, 1),
        main = _ref13$replaceEls[0];

    return crossFader.fetchImage(main).pipe(/* Cannot get final name for export "zip" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(push_state_fadeIn$, function (x) {
      return x;
    }), /* Cannot get final name for export "takeUntil" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(push_state_start$));
  }),
  ...
  /* Cannot get final name for export "startWith" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined([document.querySelector('.sidebar-bg')]), /* Cannot get final name for export "pairwise" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(), /* Cannot get final name for export "mergeMap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function (_ref14) {
  ...
  push_state_fadeIn$.pipe(/* Cannot get final name for export "tap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(/* Cannot get final name for export "default" in "./node_modules/hy-component/src/vanilla.js" (known exports: VanillaComponent, known reexports: Set) */ undefined), /* Cannot get final name for export "tap" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(setupFLIPTitle),

  // Finally, after some debounce time, send a `pageview` to Google Analytics (if applicable).
  /* Cannot get final name for export "filter" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function () {
    return !!window.ga;
  }), /* Cannot get final name for export "debounceTime" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(GA_DELAY)).subscribe(function () {
  ...
  error$.subscribe(function (_ref16) {
    ...
    loading.style.display = 'none';
    /* Cannot get final name for export "empty" in "./node_modules/qd-set/esm/index.js" (known exports: Set, known reexports: ) */ undefined.call(push_state_animationMain.querySelector('.page'));
  ...
  if (/* Cannot get final name for export "isSafari" in "./node_modules/qd-set/esm/index.js" (known exports: Set, known reexports: ) */ undefined && !navigator.standalone) {
    ...
    /* Cannot get final name for export "fromEvent" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(window, 'popstate').pipe(/* Cannot get final name for export "filter" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(function () {
    ...
    /* Cannot get final name for export "merge" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined(after$, progress$, error$).pipe(/* Cannot get final name for export "observeOn" in "./node_modules/hy-drawer/src/mixin/operators.js" (known exports: subscribeWhen filterWhen, known reexports: ) */ undefined(/* Cannot get final name for export "animationFrameScheduler" in "./_js/src/katex.js" (known exports: default, known reexports: ) */ undefined)).subscribe(function () {
...
/***/ })
/******/ ]);
//# sourceMappingURL=moji-1.0.0.js.map